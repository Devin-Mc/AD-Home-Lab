...
| Machine | OS | Role | IP |
|---|---|---|---|
| DC01 | Windows Server 2022 | Domain Controller, DNS | 192.168.10.1 |
| CLIENT01 | Windows 10 Pro | Domain-joined workstation | 192.168.10.2 |
...
**Script:** [`createusers.ps1`](createusers.ps1)  
...
| File | Description |
|---|---|
| `createusers.ps1` | PowerShell script to bulk-create AD users from CSV |
| `users.csv` | Sample user data used for provisioning |
| `README.md` | This file |
